...
box1 = Box(randint(10000, 99999), 'Omega', 'Sankt-Peterburg', 'Kazan')
print(box1.postcode, box1.name, box1.from_city, box1.target_city)
box2 = Box(randint(10000, 99999), 'IKEA', 'Sochi', 'Moscow')
print(box2.postcode, box2.name, box2.from_city, box2.target_city)
box3 = Box(randint(10000, 99999), 'Mega', 'Ufa', 'Kazan')
print(box3.postcode, box3.name, box3.from_city, box3.target_city)
box4 = Box(randint(10000, 99999), 'Megastroy', 'Moscow', 'Kazan')
...
man = Track('Man', 'black', 'mechanical')
man - box3
man + box4
print(man)